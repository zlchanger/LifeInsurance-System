...
public class LIFED001Form extends NwCommonForm{
	...
	public String ktele = "";
	public String kzipcode = "";
	public String kaddre = "";
	public String kphysical = "";
	public String koccupation = "";
	public String kamannx = "";
	public String kamannm = "";
	public String kbirthday = "";
	public String ksex = "";
	...
	public void setKtele(String ktele) {
		this.ktele = ktele;
	}
	
	public String getKtele() {
		return ktele;
	}
	...
	public void setKaddre(String kaddre) {
		this.kaddre = kaddre;
	}
	
	public String getKaddre() {
		return kaddre;
	}
	
	public void setKphysical(String kphysical) {
		this.kphysical = kphysical;
	}
	
	public String getKphysical() {
		return kphysical;
	}
	
	public void setKoccupation(String koccupation) {
		this.koccupation = koccupation;
	}
	
	public String getKoccupation() {
		return koccupation;
	}
	
	public void setKamannx(String kamannx) {
		this.kamannx = kamannx;
	}
	
	public String getKamannx() {
		return kamannx;
	}
	
	public void setKamannm(String kamannm) {
		this.kamannm = kamannm;
	}
	
	public String getKamannm() {
		return kamannm;
	}
	
	public void setKbirthday(String kbirthday) {
		this.kbirthday = kbirthday;
	}
	
	public String getKbirthday() {
		return kbirthday;
	}
