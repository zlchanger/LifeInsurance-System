...
<script type="text/javascript" language="javascript"
	src="LIFEC/LIFEC004.js" charset="utf-8"></script>
<title>契约者情报返送确认(LIFEC004)</title>
</head>
<%
...
<body>
<form name="form1">
	<input type="hidden" name="sid" value="LIFEC004">
	<input type="hidden" name="actionexcute" id="actionexcute" value="">
		...
		<tr><td>
		<table width="100%" align="center" border="0" class="px13">
		<tr><td colspan="4">契约者生年月日变更</td></tr>
			<tr><td width="5%">&nbsp;</td>
			<td width="20%">契约者生年月日：</td>
			<td width="30%"><input type="text" name="birthday" value=<%=(String)data.getBirthday() %> class="inputsty" readonly></td>
			<td width="45%">&nbsp;</td></tr>
		</table></td></tr>
		</table>
		<div>&nbsp;</div>
		...
		<tr><td>
		<table width="100%" align="center" border="0" class="px13">
		<tr><td colspan="4">契约者电话号码变更</td></tr>
			<tr><td width="5%">&nbsp;</td>
			<td width="20%">契约者电话号码：</td>
		...
		<tr><td>
		<table width="100%" align="center" border="0" class="px13">
		<tr><td colspan="4">契约者性别变更</td></tr>
			<tr><td width="5%">&nbsp;</td>
			<td width="20%">契约者性别：</td>
			<td width="30%"><input type="text" name="sex" value=<%=(String)data.getSex() %> class="inputsty" readonly></td>
			<td width="45%">&nbsp;</td></tr>
		</table></td></tr>
		</table>
		<div>&nbsp;</div>
		...
		<tr><td>
		<table width="100%" align="center" border="0" class="px13">
		<tr><td colspan="4">契约者住址变更</td></tr>
			<tr><td width="5%">&nbsp;</td>
			<td width="20%">契约者邮编：</td>
			<td width="30%"><input type="text" name="zipcode" maxlength="6" value=<%=(String)data.getZipcode() %> class="inputsty" readonly></td>
			<td width="45%">&nbsp;</td></tr>
			<tr><td width="5%">&nbsp;</td>
			<td width="20%">契约者住址：</td>
			<td width="30%"><input type="text" name="addre" value=<%=(String)data.getAddre() %> class="inputsty" readonly></td>
			<td width="45%">&nbsp;</td></tr>
		</table></td></tr>
		</table>
		<div>&nbsp;</div>
		...
		<tr><td>
		<table width="100%" align="center" border="0" class="px13">
		<tr><td colspan="4">契约者其他变更</td></tr>
			<tr><td width="5%">&nbsp;</td>
			<td width="20%">契约者身体状况：</td>
			<td width="30%"><input type="text" name="physicalcase" value=<%=(String)data.getPhysicalcase() %> class="inputsty" readonly></td>
			<td width="45%">&nbsp;</td></tr>
			<tr><td width="5%">&nbsp;</td>
			<td width="20%">契约者职业：</td>
			<td width="30%"><input type="text" name="occupation" value=<%=(String)data.getOccupation() %> class="inputsty" readonly></td>
			<td width="45%">&nbsp;</td></tr>
		</table></td></tr>
		</table>
		<div>&nbsp;</div>
