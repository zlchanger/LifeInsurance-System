...
<script type="text/javascript" language="javascript"
	src="LIFED/LIFED002.js" charset="utf-8"></script>
<title>被共济者情报变更初回确认(LIFED002)</title>
</head>
<%
...
<body>
<form name="form1">
	<input type="hidden" name="sid" value="LIFED002">
	<input type="hidden" name="actionexcute" id="actionexcute" value="">
		...
		<tr><td>&nbsp;</td></tr>
			...
			<tr><td>&nbsp;</td>
			<td>生年月日：</td>
			<td><input type="text" name="kbirthday" value=<%=(String)data.getKbirthday() %> class="inputsty" readonly></td>
			<td>&nbsp;</td>
			<td>被共济者性别：</td>
			<td><input type="text" name="ksex" value=<%=(String)data.getKsex() %> class="inputsty" readonly></td></tr>
			<tr><td width="5%">&nbsp;</td>
			...
			<tr><td>&nbsp;</td>
			<td>被共济者邮编：</td>
			<td><input type="text" name="kzipcode" maxlength="6" value=<%=(String)data.getKzipcode() %> class="inputsty" readonly></td>
			<td>&nbsp;</td>
			<td>被共济者住址：</td>
			<td><input type="text" name="kaddre" value=<%=(String)data.getKaddre() %> class="inputsty" readonly></td>
			</tr>
			<tr><td>&nbsp;</td>
			<td>被共济者身体状况：</td>
			<td><input type="text" name="kphysical" value=<%=(String)data.getKphysical() %> class="inputsty" readonly></td>
			<td colspan="3">&nbsp;</td></tr>
			<tr><td>&nbsp;</td>
			<td>被共济者职业：</td>
			<td><input type="text" name="koccupation" value=<%=(String)data.getKoccupation() %> class="inputsty" readonly></td>
			<td colspan="3">&nbsp;</td></tr>
			<tr><td>&nbsp;</td></tr>
		</table></td></tr>
		</table>
